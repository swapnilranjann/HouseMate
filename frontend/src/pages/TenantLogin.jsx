    ...
    <div className="flex min-h-[calc(100vh-80px)] bg-white">
      <div className="hidden lg:block lg:w-1/2 relative bg-gray-900">
        ...
        <div className="absolute inset-0 bg-gradient-to-t from-gray-900/60 to-transparent flex flex-col justify-end p-12">
            <h2 className="text-4xl font-extrabold text-white mb-2 leading-tight">Partner with us.</h2>
      ...
      <div className="w-full lg:w-1/2 flex items-center justify-center p-8 sm:p-12 lg:p-24 bg-white">
        <div className="w-full max-w-md">
          <div className="mb-10">
              ...
              <h1 className="text-3xl font-extrabold text-gray-900 mb-2 tracking-tight whitespace-nowrap">Owner Portal</h1>
          ...
          <form onSubmit={handleSubmit} className="space-y-6">
            <div>
              ...
              <div className="relative">
                ...
                <input type="email" required className="pl-12 w-full px-4 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 text-gray-900 transition-shadow bg-gray-50 hover:bg-white" placeholder="Enter your email" value={email} onChange={e => setEmail(e.target.value)} />
              </div>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                ...
                <input type="password" required className="pl-12 w-full px-4 py-3.5 border border-gray-200 rounded-xl focus:outline-none focus:ring-2 focus:ring-sky-500 text-gray-900 transition-shadow bg-gray-50 hover:bg-white" placeholder="Enter your password" value={password} onChange={e => setPassword(e.target.value)} />
              </div>
              <div className="flex justify-end mt-1.5">
                <Link to="/forgot-password" virtual="true" className="text-xs font-bold text-sky-600 hover:text-sky-500">Forgot password?</Link>
              </div>
            </div>
          ...
          <div className="mt-8 pt-8 border-t border-gray-100 flex items-center justify-between text-sm">
            ...
            <Link to="/tenant/register" className="font-bold text-sky-600 hover:text-sky-500 underline underline-offset-4 decoration-sky-600/20 tracking-wide">Register Property</Link>
          </div>
        </div>
      </div>
    </div>
